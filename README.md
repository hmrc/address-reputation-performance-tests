...
# address-reputation-performance-tests

Performance test suite for the `address-reputation`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
